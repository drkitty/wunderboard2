 ...
 *
 * @param left_adjust
 * ADC_LEFTADJUST Sets the ADC result to left adjust mode (8 bits in ADCH, 2
 *                bits in ADCL)
 * ADC_RIGHTADJUST Sets the ADC result to right adjust mode (2 bits in ADCH, 8
 *                 bits in ADCL)
 *
 * @see ADC_LEFTADJUST
 * @see ADC_RIGHTADJUST
